...
set t_Co=256
let colors_name = "jarsp-nerv-ous"

hi Normal	        guifg=#c555dd       guibg=none          gui=none     
hi NonText	        guifg=none          guibg=none          gui=none     
hi Comment	        guifg=#615882       gui=none
hi Constant	        guifg=#e64333       gui=none
hi Cursor	        guibg=#d0cb50       guifg=none          gui=none
...
hi Identifier	    guifg=#00e600       gui=none     
hi LineNr	        guifg=#ffff50       guibg=#262626       gui=none     
hi MatchParen	    guifg=none          guibg=#d096bb       gui=none     
hi Number	        guifg=#e64333       gui=none     
hi PreProc	        guifg=#d0cb50       gui=none     
hi Statement	    guifg=#fe9e47       gui=none     
...
hi String	        guifg=#ef880c       gui=none     
hi StorageClass	    guifg=#8eaa29       gui=none     
hi Todo		        guifg=#f5e4e6       guibg=none          gui=none     
...
if has('spell')
        hi SpellBad guisp=#e64333 gui=undercurl
